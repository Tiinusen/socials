export function routeDescriptorFor(node, pending = null) {
  if (node) {
    return {
...
export function decorateLensSource(source, descriptor, scroll = {}) {
...
export function discoveryScrollSignature(input = {}) {
...
export function stripVolatileLensState(value) {
...
export function normalizedHistoryKind(input = {}) {
...
export function shouldApplyLens(input = {}) {
